...
Blockly.JavaScript.espruino_tempRead = function() {
  var pin = Blockly.JavaScript.valueToCode(this, 'PIN', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
  return ["temperature = (analogRead(A6) * -100) + 100", Blockly.JavaScript.ORDER_ATOMIC];
};
...
Blockly.JavaScript.espruino_testAccel = function() {
  ...
  return "digitalWrite(C5, 1);\n"
	...
	+ "accz = (accz - 4096);\n"
	+ "}\n"
	+ "if(Math.abs(accx) > 512) {\n"
	+ "gsmSendPacket = true;\n"
	+ "eventType = 'tamper';\n"
	+ "}\n"
	+ "if(Math.abs(accy) > 512) {\n"
	+ "gsmSendPacket = true;\n"
	+ "eventType = 'tamper';\n"
	+ "}\n"
...
Blockly.JavaScript.espruino_cellReport = function() {
  var val1 = Blockly.JavaScript.valueToCode(this, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';
  var val2 = Blockly.JavaScript.valueToCode(this, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';
  var val3 = Blockly.JavaScript.valueToCode(this, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';
  var val4 = Blockly.JavaScript.valueToCode(this, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';
  return "Serial1.write('Power down Cell');";
...
//  var ip = Blockly.JavaScript.valueToCode(this, 'VAL', Blockly.JavaScript.ORDER_NONE;
  ...
  return "var mainSetTimeoutFrequency = 10 * 5;\n"
	...
	+ "var low_alarm_reported = false;\n"
	+ "var alarm_cleared = true;\n"
	+ "var high_alarm_reported = false;\n"
	+ "var gsmCommand = '';\n"
	+ "var gsmResponse = '';\n"
//	+ "var temperature = 73.5;\n"
	+ "var uuidhi = 1987654321;\n"
	+ "var uuidlo = 1234567890;\n"
	+ "var imei = '999999999999999';\n"
	+ "function getRandomInt(min, max) {\n"
	+ "return Math.floor(Math.random() * (max - min + 1)) + min;\n"
	+ "}\n"
	+ "var message =  '{\"data\":' +\n"
	+ "'{' +\n"
	+ "'\"analog_input_01\": \"' + temperature + '\", \"device_name\": \"999999999999999\",' +\n"
	+ "'\"device_name_type\": \"imei\",' +\n"
	+ "' \"device_type\": \"nx1_cooler_demo\",'+\n"
	+ "'\"event_type\": \"motion\",' +\n"
	...
	+ "plac = r[2];\n"
	+ "pcid = r[3];\n"
	+ "cid = parseInt(pcid,16);\n" 
	+ "lac = parseInt(plac,16);\n" 
	+ "Serial3.println(gsmSendPacketSequence[1][0]);\n"
	+ "}\n"
	+ "      if(gsmSerialSendPacketIndex === 1)\n"
	+ "      {\n"
	+ " sequence = getRandomInt(1, 9999);\n"	
	+ " uuidlo = getRandomInt(1000000000, 9999999999);\n"
	+ " uuidhi = getRandomInt(1000000000, 9999999999);\n"
	+ " message =  '{\"data\":' +\n"
	+ "'{' +\n"
	+ "' \"device_type\": \"nx1_cooler_demo\",' +\n"
	+ "' \"device_name\": \"'+imei+'\",' +\n"
	...
	+ "' \"pcell_cell_id\": \"'+cid+'\",' +\n"
	+ "'\"device_name_type\": \"imei\"';\n"
	+ "message = message + ',\"sequence_number\": \"'+sequence+'\"';\n"
	+ "if( typeof temperature !== \"undefined\" ){\n"
//	+ " temperature = temperature * 100;\n"
	+ "  tempt = (temperature + '').substring(0, 4);\n"
    + "message = message + ',\"analog_input_01\": \"'+tempt+'\"';\n"
	+ "}\n"
    + "if( typeof gpsLat !== \"undefined\" ){\n"
    + "message = message + ',\"gps_latitude\": \"'+gpsLat+'\"';\n"
	+ "}\n"    
	+ "if( typeof gpsLng !== \"undefined\" ){\n"
    + "message = message + ',\"gps_longtitude\": \"'+gpsLng+'\"';\n"
	+ "}\n"    
	+ "if( typeof gpsSpeed !== \"undefined\" ){\n"
    + "message = message + ',\"gps_speed\": \"'+gpsSpeed+'\"';\n"
	+ "}\n"    
    + "message = message + ',\"event_type\": \"'+eventType+'\"},';\n"
	+ "message = message + '\"headers\": {},\"id\": \"'+uuidhi+'-'+uuidlo+'\",\"type\": \"reading\"}';\n"
...
//	+ "         gsmSendPacket = false;\n"
	...
	+ "    }\n"
	+ "  } else {\n"
    + "    index = gsmSerialData.indexOf('IMEI:');\n"
	+ "    if (index > -1) {\n"
	+ "      index = index + 6;\n"
	+ "      var index2 = gsmSerialData.substring(index).indexOf('\\r\\n');\n"
 	+ "     if (index2 > -1) {\n"
 	+ "       imei = (gsmSerialData.substring(index, index + index2)) + '';\n"
	+ "     }\n"
	+ "      Serial1.println('recv(imei)=<' + imei + '>');\n"
	+ "    }\n"
	+ "    index = gsmSerialData.indexOf('OK\\r\\n');\n"
	+ "    if (index > -1) {\n"
	+ "      val = (gsmSerialData.substring(0, index + 2)) + '';\n"
	...
	+ " ftemp = parseFloat(temperature);\n"
	+ " Serial1.println('ftemp=' +ftemp);\n"
	+ " if((ftemp > 80.0) && (high_alarm_reported === false)) {\n"
	+ " high_alarm_reported = true;\n"
	+ " alarm_cleared = false;\n"
	+ " gsmSendPacket = true;\n"
	+ " eventType = 'temp_alarm';\n"
	+ "}"
	+ " if((ftemp < 78.0) && (alarm_cleared === false)) {\n"
	+ " gsmSendPacket = true;\n"
	+ " alarm_cleared = true;\n"
	+ " high_alarm_reported = false;\n"
	+ " eventType = 'temp_alarm_cleared';\n"
	+ "}"
	+ "if(gsmHeartbeat === true) {\n"
    + "  gsmSendPacket = true;\n"
    + "  gsmHeartbeat = false;\n"
    + "  eventType = 'heartbeat';\n"
    + "}\n"
	...
	+ "function HeartBeat() {\n"
	+ "gsmHeartbeat = true;\n"
	+ "Serial1.println('FIRING OFF HEARTBEAT');\n"
	+ "setTimeout(HeartBeat, mainSetTimeoutFrequency * 100);\n" 
	+ "}\n"
	+ "setTimeout(HeartBeat, mainSetTimeoutFrequency * 100);\n" 
	+ "setTimeout(mainLoop, mainSetTimeoutFrequency);\n";
};
...
return "function parseRMC(rmc) {\n"
  ...
  + "newRMC = parseRMC(cmd);\n"
  + "if (newRMC.status === 'A') {\n"
  + "gpsLat = (newRMC.latitude + '').substring(0, 7);\n"
  + "gpsLng = (newRMC.longitude + '').substring(0, 7);\n"
  + "gpsSpeed = newRMC.speed;\n"
  + "Serial1.println('Good GPS signal');\n"
